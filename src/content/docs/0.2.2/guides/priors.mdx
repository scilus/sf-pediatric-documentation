...
![curves](../../../../assets/0.2.2/normative_curves_and_rawdata.png)
...
Each of those median normative curves were approximate using single equations, and implemented into `sf-pediatric`. While this is the default option, users can still specify their own FRF using the parameter [`--frf_manual_frf`](/sf-pediatric/0.2.2/guides/parameters/#frf-options). Similarly, Freewater Elimination, NODDI, and COMMIT priors can be specified with [`--para_diff`](/sf-pediatric/0.2.2/guides/parameters/#diffusivities-options), [`--perp_diff`](/sf-pediatric/0.2.2/guides/parameters/#diffusivities-options), [`--iso_diff`](/sf-pediatric/0.2.2/guides/parameters/#diffusivities-options), [`--perp_diff_min`](/sf-pediatric/0.2.2/guides/parameters/#diffusivities-options), and [`--perp_diff_max`](/sf-pediatric/0.2.2/guides/parameters/#diffusivities-options).
