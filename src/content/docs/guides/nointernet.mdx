...
2. **Launching `sf-pediatric` using the SLURM scheduler**
    ...
    This will speed the pipeline execution by leveraging GPUs when possible. For more details, please see [this section](/sf-pediatric/guides/profiles/#gpu).
    :::
...
not already done, please create one by following the instructions [in this section](/sf-pediatric/guides/usage/#how-to-use-a-paramsyml-file).
:::
