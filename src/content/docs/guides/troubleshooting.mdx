...
**Solution:**
Convert your CLI parameters into a `params.yml` file. To do so, follow the instructions on [how to use a `params.yml` file](/sf-pediatric/guides/usage/#how-to-use-a-paramsyml-file).
