...
slug: 0.3.0/guides/qc
---

import { FileTree } from '@astrojs/starlight/components';
import { Steps } from '@astrojs/starlight/components';

As described in the [outputs section](/sf-pediatric/0.3.0/guides/outputs), you will find, in your output folder, two types
of MultiQC reports.
...
those can be found in the [subject-specific report](/sf-pediatric/0.3.0/guides/qc#opening-the-subject-specific-qc-report).
...
![general\_stats\_section](../../../../assets/QC/0.3.0/general_stats_section.webp)
...
![status-bar](../../../../assets/QC/0.3.0/status_bar.png)
...
![highlighting-samples](../../../../assets/QC/0.3.0/highlighting_samples.webp)
...
start opening [subject-specific](/sf-pediatric/0.3.0/guides/qc#opening-the-subject-specific-qc-report) reports!
...
![single-subject-eddy](../../../../assets/QC/0.3.0/eddy_single-subject.webp)
...
![overview](../../../../assets/QC/0.3.0/overview_single-subject.webp)
