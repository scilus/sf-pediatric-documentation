---
title: Installation
description: How to install sf-pediatric
slug: 0.3.0/guides/installation
---
...
<Steps>
     ...
     <CommandOutputs>
       ...
       <span slot="output">
         ...
         ```bash
          ...
          Launching `https://github.com/nextflow-io/helloworld` [reverent_bassi] revision: 3c2cdc9823 [master]

          executor >  local (4)
          [13/b07dc8] process > sayHello (1) [100%] 4 of 4 ✔
          Hola world!
  ...
  2. **Docker OR Apptainer**
     ...
     In order to avoid users installing all software dependencies used within `sf-pediatric`, the pipeline relies on containers for all processing steps. Those containers can be run using two technologies: **Docker** or **Apptainer**.
...
Once everything installed and/or available, you can proceed to the [inputs section](/sf-pediatric/0.3.0/guides/inputs).
